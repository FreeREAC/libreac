...
#include <reac/reac_slots.h>   /* the two slot spaces: audio fabric vs head-amp */
#include <reac/reac_grant.h>   /* struct reac_grant_alloc, REAC_GRANT_SWEEP_MAX */
#include <reac/reac_ctrlblk.h>  /* REAC_SCENE_BYTES — the transfer, from the library */
#include <reac/reac_scene_body.h>     /* reac_scene_placeholder — the body we push   */
