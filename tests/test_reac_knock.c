...
int main(void)
{
	 ...
	 * socket and a segment lock — the daemon's hearing_yield over the retained sniffer, not
	...
	/* ...and longer than two of the daemon's 200 ms hearing polls, so the silence that
