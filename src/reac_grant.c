...
#include <reac/reac_ctrl.h>        /* reac_ctrl_stamp_headamp, enum reac_headamp_param */
#include <reac/reac_headamp_tx.h>  /* struct reac_headamp_tx */
 ...
 * a per-width derivation, since retired, which agreed with the wire on all three chassis
